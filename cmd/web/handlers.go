...
func (app *application) signupUser(w http.ResponseWriter, r *http.Request) {
	...
	form.MatchesPatttern("email", forms.EmailRX)
	...
	if err == models.ErrDuplicateEmail {
		...
		app.render(w, r, "singup.page.html", &templateData{Form: form})
		return
	} else if err != nil {
		app.serverError(w, err)
		return
	...
	app.session.Put(r, "flash", "Your signup was successfuel. Please log in.")
